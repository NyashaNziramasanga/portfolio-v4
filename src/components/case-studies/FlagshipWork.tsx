  ...
  return (
    <div className="flex w-full max-w-5xl self-start flex-col">
      <div className="mb-8 sm:mb-10">
        <h2 className="text-xl font-bold text-brand-50 sm:text-2xl">Flagship Work</h2>
        <p className="mt-3 max-w-3xl text-sm leading-relaxed text-brand-300 sm:text-base">A closer look at the product problems, mobile architecture and engineering judgment behind the work.</p>
      </div>
